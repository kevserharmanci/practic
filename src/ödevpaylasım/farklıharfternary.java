...
public class farklıharfternary {
    public static void main(String[] args) {
        // Kullanıcıdan bir isim isteyin ve isim sadece 3 harfli olmalidir ternary kullanarak harflerin uniq yani farkli olup olmadigina bakiniz
